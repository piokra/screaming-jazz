...
${OBJECTDIR}/AllTextSelector.o: AllTextSelector.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AllTextSelector.o AllTextSelector.cpp
...
${OBJECTDIR}/IP4Selector.o: IP4Selector.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IP4Selector.o IP4Selector.cpp
...
${OBJECTDIR}/RequestLogger.o: RequestLogger.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RequestLogger.o RequestLogger.cpp
...
${OBJECTDIR}/URISelector.o: URISelector.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/URISelector.o URISelector.cpp
