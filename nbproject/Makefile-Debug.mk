...
${OBJECTDIR}/FileOutputFactory.o: FileOutputFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileOutputFactory.o FileOutputFactory.cpp

${OBJECTDIR}/FileOutputHandler.o: FileOutputHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileOutputHandler.o FileOutputHandler.cpp

${OBJECTDIR}/FileUtil.o: FileUtil.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileUtil.o FileUtil.cpp
...
${OBJECTDIR}/StringUtil.o: StringUtil.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StringUtil.o StringUtil.cpp
